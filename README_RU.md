...
7) parameter_distribution - для построения гистограмм распределения параметров.
...
1. processing_data.py - подготовка изображений (сжатие с ~500х500 пикселей до 224х224), создание csv-файла с разметкой, разделение этого файла на 3 (train, val, test). Есть две версии: для MFA и cluster1;
